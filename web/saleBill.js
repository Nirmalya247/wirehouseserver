...
function getBillHtmlA4V2(shop, sale, items) {
    ...
    var html = `
        <html>
            ...
            <body style="transform: scale(1); zoom: ${(process.env.PORT ? 0.60 : 1)};">
                        ...
                        <td rowspan="2" style="vertical-align: top; width: 40%;">
                            <div class="bill">
                                ...
                                <div class="invoice-date">
                                    ...
                                    <div class="value">${sale.createdAt.toDateString()}</div>
                                </div>
        ...
        html += `
            <tr class="item-tr item-tr-data">
                <td class="item-td item-td-items">
                    ...
                    <div class="item-batch">Batch NO: ${items[i].id}</div>
            ...
            <div class="total-holder">
                <div class="total-sub-holder">
                    <div class="total">
                        ...
                        <div class="value">${sale.totalCost}</div>
                    </div>
                    <div class="tendered">
                        <div class="label">Payment on May 25, 2021 using cash:</div>
                        <div class="value">${sale.totalTendered}</div>
                    </div>
